			...
			<div className="hero min-h-screen bg-base-200">
			  <div className="hero-content flex-col lg:flex-row-reverse">
			    <div className="text-center lg:text-left">
			      ...
			      <p className="py-6">You have to log in to view recipes!!</p>
			    </div>
...
{/*Form ended here*/}	
				...
				<Link to="/register" className="mt-12">
					<small className="text-grey-200 hover:text-green-700">Don't have an account? Click here to register!</small>  
				</Link>
			    </div>
			  </div>
			</div>
